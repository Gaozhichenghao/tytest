/** 
* Project Name:tytest 
* File Name:EffectiveWordMatcher.java 
* Package Name:com.PrefixMatcher 
* Date:2018年9月5日下午3:53:41 
...
public class EffectiveWordMatcher extends AbstractPrefixMatcher {
    ...
    /*
     * 将 字符串数组转化为前缀匹配对 eg. ["ab", "ac"] ===> [<"a","ab">, <"ab", "ab">, <"a",
     * "ac">, <"ac", "ac">]
     */
    ...
    /*
     * 将多个 <key,value> 合并为一个映射 eg. [<"a", "abstract">, <"b", "boolean">, <"a",
     * "assert">, <"b", "break">, <"c", "continue">] ===> {"a"=>["abstract",
     * "assert", "b"=>["boolean", "break"], "c"=>["continue"]}
     */
    ...
    public static void main(String[] args) {
        ...
        String[] prefixes = new String[] { "a", "b", "c", "d", "e", "f", "g", "i", "l", "n", "p", "r", "s", "t", "v", "w", "do",
                "finally" };
